...
<script>
	$(document).ready(function () {
		...
		$("#customerForm").submit(function (event){
			...
			const specialCharRegex_forAdd = /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/;
			...
			else if (specialCharRegex_forAdd.test(address1)) {
			...
			else if (specialCharRegex_forAdd.test(address2)) {
			...
			else if (specialCharRegex_forAdd.test(city)) {
			...
			else if (specialCharRegex_forAdd.test(state)) {
			...
			else if (specialCharRegex_forAdd.test(zip)) {
